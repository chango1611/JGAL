...
public class GAL_DoubleGeneConfig extends GAL_NumericalGeneConfig<Double>{
	...
	/**Initializes a GAL_DoubleGeneConfig with min field equal 0 and max field equal Double.MAX_VALUE*/
	...
	*/
	...
	/**Constructs a new GAL_DoubleGeneConfig object with minimum and maximum values for the trait of a GAL_Gene.
	...
	*/
	...
	/**Assigns a random value to the trait of a double GAL_Gene object with an equal probability to get any number in the range [min,max) as the trait value.
