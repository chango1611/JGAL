...
class caso1_B{
	...
	public static void main(String[] args)throws Exception{
		...
		GAL_Configuration config= new GAL_Configuration(new GAL_ChromosomeConfig(geneConfig),new miCondicionTerminacion(),new miFuncionAptitud(), new GAL_RouletteSelector(),
		new GAL_GeneticOperator[] {new GAL_MultiPointCrossover(0.7,2),new GAL_Mutation(0.0175)});
