...
class caso1_D{
	...
	public static void main(String[] args)throws Exception{
		...
		GAL_Configuration config= new GAL_Configuration(new GAL_ChromosomeConfig(geneConfig),new miCondicionTerminacion(),new miFuncionAptitud(), new GAL_ClassicRankingSelector(2),
